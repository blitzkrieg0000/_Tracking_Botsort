...
class BoTSORT(object):
    ...
    def update(self, output_results, img):
        ...
        if len(output_results):
            ...
            # Eşik değerinin altında olan puanları filtrele
            ...
            # En iyi puana sahip olan tespitleri bul
        ...
        '''Re-id için embedding leri çıkar. '''
        ...
        ''' Yeni algılanan trackletleri tracked_stracks'a ekle'''
        unconfirmed = []
        ...
        ''' Adım 2: Yüksek skorlu bboxlar ile ilk eşleştirme'''
        strack_pool = joint_stracks(tracked_stracks, self.lost_stracks)

        # Kalman Filtresi ile mevcut konumu tahmin et
        STrack.multi_predict(strack_pool)

        # Kamera hareketini düzelt
        warp = self.gmc.apply(img, dets) # +Optical Flow
